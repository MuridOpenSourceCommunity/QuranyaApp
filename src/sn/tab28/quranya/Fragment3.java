...
public class Fragment3 extends SherlockFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mTabHost.setup(getSherlockActivity(), getChildFragmentManager(), R.layout.fragment3);

		mTabHost.addTab(mTabHost.newTabSpec("tab3").setIndicator(getActivity().getResources().getString(R.string.jukky3)), FragmentTab3.class, null);
